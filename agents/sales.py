...
SYSTEM = (
    ...
    "(3) proponer siguiente paso (demo, llamada, cotización), "
    "y (4) responder con tono cordial, claro y breve. "
    "Siempre en español y en Markdown."
)
...
def run_sales(user_text: str, *, context: str = "", rag_context: str = "", model_name: Optional[str] = None, temperature: float = 0.3) -> str:
    ...
    prompt_parts.append(
        ...
        f"{user_text}\n\n"
        "Devuélveme un bloque Markdown con:\n"
        "1) Resumen del interés del lead.\n"
        "2) Calificación (frío/templado/caliente) con breve motivo.\n"
        "3) Objeciones o dudas posibles.\n"
